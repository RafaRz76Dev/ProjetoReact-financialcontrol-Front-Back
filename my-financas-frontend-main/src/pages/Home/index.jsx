...
export const Home = () => {
  ...
  function handleSeachFinance(data) {
    api
      .get(
        `/listar/financa/dataInicial/${data.dataInicial}/dataFinal/${data.dataInicial}/page/0`
      )
      .then((response) => {
        setList(response.data.rows);
      });
